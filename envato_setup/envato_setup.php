	...
	public function setup_wizard_header() {
		...
		<?php if ( 'next_steps' === $this->step ) : ?>
			<a class="wc-return-to-dashboard"
			   href="<?php echo esc_url( admin_url() ); ?>"><?php esc_html_e( 'Return to the WordPress Dashboard','listeo' ); ?></a>
		<?php endif; ?>
		</body>
		<?php
			...
			if ( false && isset( $_REQUEST['debug'] ) ) {
				...
				<p class="envato-setup-actions step">
					<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
					   class="button-primary button button-large button-next"><?php esc_html_e( 'Let\'s Go!' ,'listeo'); ?></a>
					<a href="<?php echo esc_url( wp_get_referer() && ! strpos( wp_get_referer(), 'update.php' ) ? wp_get_referer() : admin_url( '' ) ); ?>"
					   class="button button-large"><?php esc_html_e( 'Not right now','listeo' ); ?></a>
				</p>
				<?php
				...
				<ul>
					<li>
						<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
						   class="button-primary button button-next button-large"><?php esc_html_e( 'Run Setup Wizard Again','listeo' ); ?></a>
					</li>
					
				</ul>
				<p class="envato-setup-actions step">
					<a href="<?php echo esc_url( wp_get_referer() && ! strpos( wp_get_referer(), 'update.php' ) ? wp_get_referer() : admin_url( '' ) ); ?>"
					   class="button button-large"><?php esc_html_e( 'Cancel','listeo' ); ?></a>
				</p>
				<?php
			} else {
			...
			<form method="post">
				...
				<p class="envato-setup-actions step">
					<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
					   ...
					   data-callback="install_plugins"><?php esc_html_e( 'Continue','listeo' ); ?></a>
					<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
					   class="button button-large button-next"><?php esc_html_e( 'Skip this step','listeo' ); ?></a>
		...
		public function envato_setup_default_content() {
			...
			<form method="post">
				...
				<p class="envato-setup-actions step">
					<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
					   class="button-primary button button-large button-next"
					   data-callback="install_content"><?php esc_html_e( 'Continue','listeo' ); ?></a>
					<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
					   class="button button-large button-next"><?php esc_html_e( 'Skip this step','listeo' ); ?></a>
					<?php wp_nonce_field( 'envato-setup' ); ?>
				</p>
		...
		public function _content_install_settings() {
			...
			foreach ( $custom_options as $option => $value ) {
				...
				if ( $option == 'listeo_listing_types' ) {
...
/*realteo_pages":{"my_account_page":"246","bookmarks_page":"253","my_properties_page":"258","submit_property_page":"260","change_password_page":"263","property_packages_page":"507"}*/
            ...
            <form method="post">
                ...
                <p class="envato-setup-actions step">
                    <input type="submit" class="button-primary button button-large button-next"
                           value="<?php esc_attr_e( 'Continue' ,'listeo'); ?>" name="save_step"/>
                    <a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
                       class="button button-large button-next"><?php esc_html_e( 'Skip this step','listeo' ); ?></a>
					<?php wp_nonce_field( 'envato-setup' ); ?>
                </p>
			...
			<?php if ( function_exists( 'envato_market' ) ) { ?>
				<form method="post">
					...
					if ( count( $my_items ) ) {
						...
						<p class="envato-setup-actions step">
							<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
							   class="button button-large button-next button-primary"><?php esc_html_e( 'Continue','listeo' ); ?></a>
						</p>
						<?php
					} else {
						?>
						...
						<p class="envato-setup-actions step">
							<input type="submit" class="button-primary button button-large button-next"
							       value="<?php esc_attr_e( 'Login with Envato' ,'listeo'); ?>" name="save_step"/>
							<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
							   class="button button-large button-next"><?php esc_html_e( 'Skip this step','listeo' ); ?></a>
							<?php wp_nonce_field( 'envato-setup' ); ?>
						</p>
		...
		public function envato_setup_customize() {
			...
			<p class="envato-setup-actions step">
				<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
				   class="button button-primary button-large button-next"><?php esc_html_e( 'Continue','listeo' ); ?></a>
			</p>
		...
		public function envato_setup_help_support() {
			...
			<ul>
				<li>Customization services (this is available through <a
						href="https://codeable.io/?ref=MzT0b"
						target="_blank">co​dable.io</a>)
				</li>
				<li>Installation services (this is available through <a
						href="https://studio.envato.com/explore/wordpress-installation/37124-wordpress-theme-installation-and-setup"
		...
		public function envato_setup_ready() {
			...
			<a href="https://twitter.com/share" class="twitter-share-button"
			   ...
			   data-text="<?php echo esc_attr( 'I just installed the ' . wp_get_theme() . ' #WordPress theme from #ThemeForest' ,'listeo'); ?>"
	...
	<p>			 Login to your WordPress
			...
			<div class="envato-setup-next-steps">
				<div class="envato-setup-next-steps-first">
					...
					<ul>
						<li class="setup-product"><a class="button button-primary button-large"
						                             href="https://twitter.com/purethemes"
						                             target="_blank"><?php esc_html_e( 'Follow @purethemes on Twitter','listeo' ); ?></a>
						</li>
						<li class="setup-product"><a class="button button-next button-large"
						                             href="<?php echo esc_url( home_url() ); ?>"><?php esc_html_e( 'View your new website!','listeo' ); ?></a>
						</li>
					</ul>
				</div>
				<div class="envato-setup-next-steps-last">
					...
					<ul>
						<li class="documentation"><a href="http://www.docs.purethemes.net/listeo/"
						                             target="_blank"><?php esc_html_e( 'Read the Theme Documentation','listeo' ); ?></a>
						</li>
						<li class="howto"><a href="https://wordpress.org/support/"
						                     target="_blank"><?php esc_html_e( 'Learn how to use WordPress','listeo' ); ?></a>
						</li>
						<li class="rating"><a href="http://themeforest.net/downloads"
						                      target="_blank"><?php esc_html_e( 'Leave an Item Rating' ,'listeo'); ?></a></li>
